...
class Response {
    ...
    public function __construct($statusCode, $statusText){
    	...
    	$this->statusText = $statusText != null ? $statusText : isset($this->statusTexts[$statusCode]) ? $this->statusTexts[$statusCode] : 'Unknown Status';

    	header($_SERVER['SERVER_PROTOCOL']. " {$this->statusCode} {$this->statusText}");
    }
